...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 29 15:26:03 2022
...
x_train= pd.read_csv('bigdata_train.csv',header=None)
x_test= pd.read_csv('bigdata_test.csv', header=None)
...
print('time taken to run the RandomForest is (in seconds)' ,end - start)
